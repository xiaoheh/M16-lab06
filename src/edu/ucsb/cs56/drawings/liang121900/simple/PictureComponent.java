package edu.ucsb.cs56.drawings.liang121900.simple;
...
{  
	...
	Circle snowManTopCircle=
	    ...
	    (
	     snowManCenterBottomX,
	     snowManCenterBottomY-headRadius-2*middleRadius-bottomRadius*2,
	     headRadius
	     );
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("snowman with three circles, Zhiliang Xie", 20,20);
