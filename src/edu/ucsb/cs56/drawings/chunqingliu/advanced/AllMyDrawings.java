...
public class AllMyDrawings
{
	...
	Phone h1 = new Phone(150,150,50,75);
	...
	// Draw two phones with buttons
	
	PhoneWithButton pw1 = new PhoneWithButton(50,150,40,75);
	PhoneWithButton pw2 = new PhoneWithButton(50,290,200,100);
	
	g2.draw(pw1);
	g2.setColor(new Color(0x8F00FF)); g2.draw(pw2);
	
	// @@@ FINALLY, SIGN AND LABEL DRAWING
	
	g2.setStroke(orig);
	g2.setColor(Color.BLACK); 
	g2.drawString("A few phones by Chunqing", 20,20);
    }
